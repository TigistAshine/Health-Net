...
if(isset($_POST['submit']))
{
	...
	{
			$sql ="UPDATE reception SET receptionname='$_POST[receptionname]',mobileno='$_POST[mobileno]',departmentid='$_POST[departmentid]',username='$_POST[username]',password='$_POST[password]',status='$_POST[status]',education='$_POST[education]',experience='$_POST[experience]' WHERE receptionid='$_GET[editid]'";
	...
	$sql = "SELECT * FROM account WHERE username='$_POST[username]' AND password='$_POST[password]'";
			...
			$sql ="INSERT INTO reception(receptionname,mobileno,departmentid,education,experience,accId) values('$_POST[receptionname]','$_POST[mobileno]','$_POST[departmentid]','$_POST[education]','$_POST[experience]','$accId')";
			if($qsql = mysqli_query($con,$sql))
	{
...
function validateform()
{
	...
	else if(document.frmreception.username.value == "")
	{
		alert("Login ID should not be empty..");
		document.frmreception.username.focus();
		return false;
	}
	else if(!document.frmreception.username.value.match(alphanumericExp))
	{

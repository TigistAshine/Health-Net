...
{
	$sql = "UPDATE account SET password='$_POST[newpassword]' WHERE  accountid='$_SESSION[nurseid]'";
...
<div class="wrapper col4">
  <div id="container">
      <form method="post" action="" name="frmnursechange" onSubmit="return validateform1()">

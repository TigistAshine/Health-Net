...
if(isset($_SESSION['nurseid'])){
  ...
  if(isset($_SESSION['laboratoristid'])){
	header('Location: laboratoristaccount.php');
  }
if(isset($_POST['submit']))
{
	...
	// }
		...
		$_SESSION['laboratoristid'] = $rslogin['accountId'];
		header('Location: laboratoristaccount.php');
	  }
	}
	 else
...
{
	if(document.frmdoctorlogin.username.value == "")
	{
		alert("User Name should not be empty..");
		document.frmdoctorlogin.username.focus();
		return false;
	}
	else if(!document.frmdoctorlogin.username.value.match(alphanumericExp))
	{
		alert("User Namenot valid..");
		document.frmdoctorlogin.username.focus();
		return false;
	}

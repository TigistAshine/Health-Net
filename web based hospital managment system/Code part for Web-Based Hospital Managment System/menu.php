...
<li><a href=" ######### ">Reception</a>
    <ul>
   <li><a href="addreception.php">Add reception</a></li>
        <li><a href="viewreception.php">View reception Records</a></li>
    </ul>
</li>
<li><a href=" ######### ">Patient</a>
    <ul>
...
<li><a href=" ######### ">Nurse</a>
   ...
   <li><a href="addnurse.php">Add nurse</a></li>
        <li><a href="viewnurse.php">View nurse Records</a></li>
    </ul>
</li>
...
<li><a href=" ######### ">Doctor</a>
   ...
   <li><a href="adddoctor.php">Add Doctor</a></li>
        <li><a href="viewdoctor.php">View Doctor Records</a></li>
    </ul>
</li>
<li><a href=" ######### ">Laboratorist</a>
    <ul>
   <li><a href="addlaboratorist.php">Add Laboratorist</a></li>
        <li><a href="viewlaboratorist.php">View Laboratorist Records</a></li>
    </ul>
</li>
<!-- <li>

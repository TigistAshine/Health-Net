...
if(isset($_POST['submit']))
{
	...
	{
			$sql ="UPDATE nurse SET nursename='$_POST[nursename]',mobileno='$_POST[mobileno]',departmentid='$_POST[departmentid]',username='$_POST[username]',password='$_POST[password]',status='$_POST[status]',education='$_POST[education]',experience='$_POST[experience]' WHERE nurseid='$_GET[editid]'";
	...
	$sql ="INSERT INTO account(username,password,role,status) values('$_POST[username]','$_POST[password]','$role','$status')";
		if($qsql = mysqli_query($con,$sql))
		{
			...
			$sql ="INSERT INTO nurse(nursename,mobileno,departmentid,education,experience,accId) values('$_POST[nursename]','$_POST[mobileno]','$_POST[departmentid]','$_POST[education]','$_POST[experience]','$accId')";
			if($qsql = mysqli_query($con,$sql))
			{
...
function validateform()
{
	...
	else if(document.frmnurse.username.value == "")
	{
		alert("User Name should not be empty..");
		document.frmnurse.username.focus();
		return false;
	}
	else if(!document.frmnurse.username.value.match(alphanumericExp))
	{

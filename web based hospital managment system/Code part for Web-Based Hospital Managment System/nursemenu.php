...
<li><a href=" ######### ">Patient</a>
    <ul>
   <!-- <li><a href="addpatient.php">view Patient information</a></li> -->
        <li><a href="viewpatientinfo_nurse.php">view Patient information</a></li>
    </ul>
</li>
...
<div id="mmenu">
    <li><a href=" ######### ">Patient</a>
        <ul>
       <li><a href="viewpatientinfo_nurse.php">view Patient informationt</a></li>
        </ul>
    </li>

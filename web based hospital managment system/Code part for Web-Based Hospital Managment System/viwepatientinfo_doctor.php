...
if(isset($_GET[selectmrn]))
{
	$sql ="SELECT FROM patient_test WHERE mrn='$_GET[selectmrn]";
...
<h2>Search patient<input type="search" class="light-table-filter" data-table="order-table" placeholder="Filtrer" /></h2>
    <table class="order-table">
      <thead>
        <tr>
          <td width="50%" height="40">MRN</td>
          <td width="50%" height="40">Phone No</td>
       ...
       <?php
        ...
        echo "<tr>
          ...
          <td>&nbsp;$rs[note]</td>
          <td>&nbsp;
		  <a href='fillpatientstatus.php?fillid=$rs[doctorid]'>Fill</a>| <a href='fillpatientstatus.php?selectid=$rs[doctorid]'>Send</a> </td>
        </tr>";
		}
		?>
      </tbody>

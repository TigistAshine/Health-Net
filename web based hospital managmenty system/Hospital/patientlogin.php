...
{
	if(document.frmpatientlogin.loginid.value == "")
	{
		alert("Login ID should not be empty..");
		document.frmpatientlogin.loginid.focus();
		return false;
	}
	else if(!document.frmpatientlogin.loginid.value.match(alphanumericExp))
	{
		alert("Login ID not valid..");
		document.frmpatientlogin.loginid.focus();
		return false;
	}
	else if(document.frmpatientlogin.password.value == "")
	{
		alert("Password should not be empty..");
		document.frmpatientlogin.password.focus();
		return false;
	}
	else if(document.frmpatientlogin.password.value.length < 8)
	{

...
if(isset($_POST[submit]))
{
	...
	{
			$sql ="UPDATE admin SET patientname='$_POST[patientname]',loginid='$_POST[loginid]',password='$_POST[password]',status='$_POST[select]' WHERE patientid='$_GET[editid]'";
	...
	{
	$sql ="INSERT INTO patient(patientname,loginid,password,status) values('$_POST[patientname]','$_POST[loginid]','$_POST[password]','$_POST[select]')";
	if($qsql = mysqli_query($con,$sql))
	{
...
function validateform()
{
	...
	else if(document.frmpatient.password.value != document.frmpatient.cnfirmpassword.value )
	{

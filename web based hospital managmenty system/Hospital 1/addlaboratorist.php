...
if(isset($_POST['submit']))
{
	...
	{
			$sql ="UPDATE laboratorist SET laboratoristname='$_POST[laboratoristname]',mobileno='$_POST[mobileno]',departmentid='$_POST[departmentid]',loginid='$_POST[loginid]',password='$_POST[password]',status='$_POST[status]',education='$_POST[education]',experience='$_POST[experience]' WHERE laboratoristid='$_GET[editid]'";
	...
	{
	$sql ="INSERT INTO laboratorist(laboratoristname,mobileno,departmentid,loginid,password,status,education,experience) values('$_POST[laboratoristname]','$_POST[mobileno]','$_POST[departmentid]','$_POST[loginid]','$_POST[password]','Active','$_POST[education]','$_POST[experience]')";
	if($qsql = mysqli_query($con,$sql))
	{
